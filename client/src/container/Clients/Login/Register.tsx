...
import { Alert, Button, Flex, Form, Input, Radio, Result, Spin, message, } from 'antd'
                    ...
                    <div className={style.formRegister}>
                        ...
                        <div className={style.inputRegister}>
                            ...
                            >
                                ...
                                >
                                    <Input className={style.formInputReg}
                                ...
                                >
                                    <Radio.Group defaultValue={'M'} onChange={(event) => handleOnChange(event.target.value, 'gender')} >
                                    ...
                                    rules={[
                                        ...
                                        ({ getFieldValue }) => ({
                                            validator(_, value) {
                                                ...
                                                if (!value || (isValistEmail && getFieldValue('email') === value)) {
                                ...
                                <div className={style.formBtn}>
                                    <Button className={style.btnPrimary} onClick={handleRegister} >Register</Button>
                                    <Button className={style.btnBlue} onClick={() => navigate('/login')} >Login</Button>
                                </div>
                            </Form>
                        </div>
                    </div>
