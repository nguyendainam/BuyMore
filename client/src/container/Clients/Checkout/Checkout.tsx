        ...
        <div className={style.mainVieww}>
            ...
            {isLoading ? (
                ...
                <div className={style.right}>
                            ...
                            >
                                ...
                                <Column
                                    ...
                                    render={(value) => {
                                        ...
                                        if (value.Discount > 0) {
                                            price =
                                                value.TotalPrice - value.TotalPrice * (value.Discount / 100);
                                        }
                    ...
                    {total > 0 ? <div className={style.formPaypal}>
                        <Paypal amount={totalUSD} cart={userCart} address={dataAddress} totalVND={total} />
                    </div> : ''}
                </div>
            )}{" "}
        </div>
